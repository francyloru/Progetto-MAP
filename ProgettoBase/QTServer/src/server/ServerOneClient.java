                ...
                switch (scelta) {
                        ...
                        try {
                            while (true) {
                                try {
                                    ...
                                    out.writeObject("Error, the table is empty or does not exist");
                            ...
                            do {
                                while (true) {
                                    try {
                                        ...
                                        out.writeObject("Error, the QT algorithm returned only one cluster");
                                        ripetere_menu = 'n';
                            ...
                            } while (Character.toLowerCase(ripetere) == 'y');

                        } catch (EmptyDatasetException vuoto) {
                            System.err.println("   |-> " + socket
                                    + ": Error, the dataset on which the QT algorithm was run is empty");
                            out.writeObject("Error, the dataset on which the QT algorithm was run is empty");
                            ripetere_menu = 'n';

                        } catch (FileNotFoundException file) {
                            System.err.println("   |-> " + socket + ": Error saving the ClusterSet to file");
                            out.writeObject("Error saving the ClusterSet to file");
                            ripetere_menu = 'n';
                    ...
                    case 3:// se dobbiamo caricare un clusterset da file
                        ...
                        try {
                            ...
                            out.writeObject(
                                    "The file was not found, possible causes:\n  - The name of the table is incorrect\n  - The radius is not valid (or is not a number)\n  - The QT algorithm has never been launched on this table using this radius\n  - There are no files containing ClusterSet");
